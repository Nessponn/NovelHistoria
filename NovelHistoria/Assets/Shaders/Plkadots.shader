...
Shader "Shader Forge/Plkadots" {
    Properties {
        ...
        _node_8595 ("node_8595", Range(-0.05, 0)) = 0
...
////// Emissive:
                ...
                float2 node_7214 = ((node_8363+node_7508.g*float2(0.04,-0.05))*(partZ*_node_8598_var));
